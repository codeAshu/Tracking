...
<plannerBenchmark>
  <benchmarkDirectory>local/data/machinebalancing/template</benchmarkDirectory>
  <parallelBenchmarkCount>AUTO</parallelBenchmarkCount>
  <warmUpSecondsSpentLimit>30</warmUpSecondsSpentLimit>

  <inheritedSolverBenchmark>
    <problemBenchmarks>
      <xStreamAnnotatedClass>org.optaplanner.examples.CloudBalance</xStreamAnnotatedClass>
    ...
    <solver>
      <solutionClass>org.optaplanner.examples.CloudBalance</solutionClass>
      <entityClass>org.optaplanner.examples.CloudProcess</entityClass>
